...
| `staging.raw_<connector>` | RANGE weekly on `ingested_at` | Raw JSONB is bulky and expires on the 90-day default window (§10); weekly partition drops keep bloat bounded. |
