...
## 5. Phase 1 – Ingestion core + first connectors (v0.2)
...
## 9. Phase 5 – Enterprise hardening (v1.0)
...
### 9.5 Demo milestone — what can be shown
...
- **Twelve remaining connectors compress into one phase** → they are P2 by design; SPI + simulation-first pattern proven since Phase 1 makes each connector incremental; scope can shed to 1.1 without breaking 1.0 (see section 11).
