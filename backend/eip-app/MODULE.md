...
Composition root / main API app: Spring Boot entry point, REST controllers, OpenAPI (springdoc), OIDC + local-account security filter chain, problem+json advice, actuator. No business logic — a Spring Boot app-class stub in this scaffold.
